...
/** CEuro unit definitions. Encapsulates parsing and formatting
   and serves as list model for dropdown selection boxes.
*/
class CEuroUnits: public QAbstractListModel
{
public:
    explicit CEuroUnits(QObject *parent);
...
typedef CEuroUnits::Unit CEuroUnit;
